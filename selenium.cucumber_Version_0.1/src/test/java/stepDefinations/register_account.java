...
public class register_account {
	...
	public void validate_message_your_personal_settings_have_been_registered_on_next_page() {
		...
		/*
		String login_exists=signup.user_already_exists().getText();
		
		if(login_exists.equals("This login is already in use")) {
			System.out.println(" This User name already Registered please use New user details To Register");
				}
		
		else {
			System.out.println("Registration Confirmation Message is " + signup.confirmation_message().getText());
		}
	...
	public void click_on_compose_on_home_page_and_enter_message_and_click_on_send_message(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
